...
function Footer() {
  return (
    <div className='w-[100%] md:h-[36vh] h-[21vh] mb-[77px] md:mb-[0px]'>
        <div className='w-[100%] md:h-[30vh] h-[15vh]  md:mb-[0px] bg-[#dbfcfcec] flex items-center justify-center md:px-[50px] px-[5px]'>
            <div className='md:w-[30%] w-[35%] h-[100%] flex items-start justify-center flex-col gap-[5px]  '>
                <div className='flex items-start justify-start gap-[5px] mt-[10px] md:mt-[40px]'>
                    ...
                    <p className='text-[19px] md:text-[20px] text-[black] '>AI Bazaar</p>
            
                </div>
                <p className='text-[15px] text-[#1e2223] hidden md:block'>AI Bazaar is your all-in-one online shopping destination, offering top-quality products, unbeatable deals, and fast delivery—all backed by trusted service designed to make your life easier every day.</p>
            ...
            <div className='md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col text-center'>
                ...
                <div className='md:w-[25%] w-[40%]  h-[100%] flex items-center justify-center flex-col text-center '>
                     ...
                     <ul>
                         <li className='text-[15px] text-[#1e2223] '>+91-9124076708</li>
                        <li className='text-[15px] text-[#1e2223] '>beheraabinash656@gmail.com</li>
        ...
        <div className='w-[100%] h-[5vh] bg-[#dbfcfcec] flex items-center justify-center'>Copyright 2025@AI Bazaar.com-All Rights Reserved</div>
