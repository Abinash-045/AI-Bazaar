...
function Nav() {
  ...
  return (
    <div className='w-[100vw] h-[70px] bg-[#1bdbdbec] z-10 fixed top-0 flex  items-center justify-between px-[30px] shadow-md shadow-black '>
       ...
       <div className='w-[20%] lg:w-[30%] flex items-center justify-start gap-[10px] cursor-pointer group transition-all duration-300 hover:scale-[1.02]'>
  <img src={logo} alt="logo" className='w-[30px]' />
  <h1 className='text-[25px] text-black font-sans group-hover:text-[#ff4ddb] transition-colors duration-300'>
    AI Bazaar
  </h1>
</div>
  ...
  <ul className='flex items-center justify-center gap-[19px] text-[white]'>
    <li
      className='text-[15px] bg-[#d1fae5] text-black py-[10px] px-[20px] rounded-2xl cursor-pointer transition-all duration-300 hover:shadow-[0_0_15px_#ff4ddb] hover:text-[#ff4ddb]'
      onClick={() => navigate("/")}
    >
      HOME
    </li>
